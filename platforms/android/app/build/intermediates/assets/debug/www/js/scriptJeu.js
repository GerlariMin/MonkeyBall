$(document).ready(function() {
    ...
    var vx = Math.random()*10.0;
    var vy = Math.random()*10.0;
    var ax = 0,ay = 0;
    var d = .5, e= .004;

    //var diametreBalle = 20;
    if(canvas.width<canvas.height){
        var diametreBalle = canvas.width*.02;
    }else{
        var diametreBalle = canvas.height*.02;
    }
    ...
    function animate(){
        if(canvas.width!=window.innerWidth-4 && canvas.height!=window.innerHeight-canvas.offsetTop-footer.offsetHeight){
    ...
    function touch(){
        ...
        if(pause%2==1){
            ...
            Swal.fire({
                ...
                onClose: () => {
                    Swal.fire({
                        title: 'La partie va reprendre!',
                        html: 'La partie reprend dans <b></b> secondes.',
                        timer: 3200,
                        onBeforeOpen: () => {
                          Swal.showLoading()
    ...
    function theme(){
        ...
        switch($('#theme').val()){
            ...
            case '2':
                bgImg = "trees.png";
                /*sonambiance = new sound("sound/forest.mp3");
                sonambiance.play();*/
                break;
            default:
                bgImg = "abstract.png";
    ...
    function update(){
        ...
        if(gagne()){
            ...
            Swal.fire({
                ...
                //footer: '<a href="pourquoi-je-suis-nul.html">Pourquoi je suis aussi nul?</a>',
                width: 600,
                padding: '3em',
                background: '#fff url(img/trees.png)',
                confirmButtonText: 'REJOUER',
        ...
        if(document.getElementById('modal').className!="modal fade show" && document.getElementById('helpModal').className!="modal fade show"){
            x = x + d*vx;
            y = y + d*vy;
            vx = vx + d*ax;
            vy = vy + d*ay;
    ...
    function volume(){
        ...
        if(son%2==1){
            ...
            //sonambiance = new sound("");
            $('#volume').html('<b><i class="fas fa-volume-mute"></i></b>');
        }else{
            sonVictoire = new sound("sound/win.mp3");
            sonDefaite = new sound("sound/lose.mp3");
            $('#volume').html('<b><i class="fas fa-volume-up"></i></b>');
        }
    }
